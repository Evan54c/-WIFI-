...
<body ><!--  bgcolor="#EEF9FA" style="font-family: STKaiti">
	...
	<br/>
	<form action="UploadServlet" method="post" enctype="multipart/form-data" style="font-size:17px">
		上传指纹库文件编号：<input name="no" style="width: 145px; height: 17px;" />
		<br/><br/>
		上传指纹库文件：<input type="file" name="指纹库文件" style="font-family: STKaiti;font-size:15px"/>
		<br/><br/><br/>
		<input type="submit" value="提交" style="width: 240px; height: 30px;border-width: 2px; border-radius: 5px;background:#5FD7ED;cursor: pointer; outline: none; font-family: STXingkai;color:white;font-size: 18px;"/>
	</form>-->
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content"style="text-align:center;">
							...
							<br/><br/>
							<p class="white-text" style = "font-family: STKaiti">指纹库上传，该网站计算的指纹库格式是按给定的android端app的采集结果。
							</p>
							<br/><br/>
							<div style="width:100%;text-align:center; margin-left: 350px;">
								<form action="UploadServlet" method="post" enctype="multipart/form-data"  style="width: 240px;text-align:center;font-family: STKaiti; font-size:18px">										
										<p align="left">上传指纹库文件编号：<input name="no" style="width: 60px; height: 25px;" /></p>										
										<p align="left">上传指纹库文件：</p>
