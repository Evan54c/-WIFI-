<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="org.rssi.entity.ResultPoint" isELIgnored="false"%>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body><!--   bgcolor="#EEF9FA" style="font-family: STKaiti">
	...
	<br/>
		<font style="font-size:17px">
				<%
				//ResultPoint resultPoint = (ResultPoint) session.getAttribute("result");
				//out.println("计算得到的坐标为：<br/><br/>X="+resultPoint.getX()+"<br/><br/>Y="+resultPoint.getY());
				%>
		</font>
	<br/><br/>
	<a href="index.jsp">
		<button style="width: 240px; height: 30px;border-width: 2px; border-radius: 5px;background:#5FD7ED;cursor: pointer; outline: none; font-family: STXingkai;color:white;font-size: 17px;">
			点击返回主页面
		</button>
	</a><br/>-->
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							...
							<br/>
							<br/>
							<font style="font-size:17px;font-family: STKaiti;color:white;font-size: 17px;">
							<%
								ResultPoint resultPoint = (ResultPoint) session.getAttribute("result");
								out.println("计算得到的坐标为：<br/><br/>X="+resultPoint.getX()+"<br/><br/>Y="+resultPoint.getY());
							%>
